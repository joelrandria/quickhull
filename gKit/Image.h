    ...
    void setPixel( const unsigned int offset, const Vec4& color )
    {
        switch(type)
        {
            case UNSIGNED_BYTE: 
            {
                ...
                {
                    case 4: p[3]= (unsigned char) (color.a * 255.f);
					case 3: p[2]= (unsigned char)(color.b * 255.f);
					case 2: p[1]= (unsigned char)(color.g * 255.f);
					case 1: p[0]= (unsigned char)(color.r * 255.f);
                        break;
                    default:
